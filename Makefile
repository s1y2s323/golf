...
pkgdatadir = $(datadir)/golf
pkgincludedir = $(includedir)/golf
pkglibdir = $(libdir)/golf
pkglibexecdir = $(libexecdir)/golf
...
PACKAGE_NAME = golf
PACKAGE_STRING = golf 1
PACKAGE_TARNAME = golf
...
STRIP = 
VERSION = 1
abs_builddir = /home/bkeys/Devel/golf
abs_srcdir = /home/bkeys/Devel/golf
abs_top_builddir = /home/bkeys/Devel/golf
abs_top_srcdir = /home/bkeys/Devel/golf
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/bkeys/install-sh
...
src/GolfGame.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Course.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Game.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Club.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
src/Ground.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Vector3d.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/Tile.$(OBJEXT): src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
...
include src/$(DEPDIR)/GolfGame.Po
include src/$(DEPDIR)/Ground.Po
include src/$(DEPDIR)/Platform.Po
include src/$(DEPDIR)/Tile.Po
include src/$(DEPDIR)/Vector3d.Po
